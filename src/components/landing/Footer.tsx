...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/30 bg-white/50 backdrop-blur-lg">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex space-x-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="rounded-full border border-white/40 bg-white/60 p-2 text-gray-500 shadow-soft backdrop-blur-sm transition-colors hover:border-primary-200 hover:bg-primary-50 hover:text-primary-600"
                >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link
                  to="/dashboard"
                  className="group inline-flex items-center gap-1 text-sm text-gray-500 transition-colors hover:text-primary-600"
                >
                  Dashboard
        ...
        <motion.div
          ...
          className="mt-10 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-white/40 pt-6"
        >
          <p className="text-sm text-gray-500">
            © {currentYear} Maniesta ResumeAI. All rights reserved.
          </p>
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-sm font-medium text-primary-600 hover:text-primary-500 transition-colors"
            >
              Built by Usman Murtaza
              <ExternalLinkIcon size={14} className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            </a>
          </div>
        </motion.div>
      </div>
