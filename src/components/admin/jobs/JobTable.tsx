            ...
            <tr key={job.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <span className={`px-2 py-1 text-xs rounded-full ${
                  ...
                  job.status === 'scheduled' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-600'
                }`}>
                  {job.status}
                </span>
              </td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                <button onClick={() => onEdit(job)} className="text-primary-600 hover:text-primary-800" aria-label="Edit">
                  <EditIcon size={18} />
                </button>
                <button onClick={() => onDelete(job.id)} className="text-red-600 hover:text-red-800" aria-label="Delete">
                  <DeleteIcon size={18} />
                </button>
              </td>
            </tr>
